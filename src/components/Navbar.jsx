      ...
      <div className="flex justify-between h-16">
        <div className="flex  items-center gap-6">
          ...
          <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
            ...
            <Link
              to={'/solutions'}
              className="border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium cursor-disabled"
            >
              Solutions
            </Link>
            <Link
